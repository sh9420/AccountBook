...
// 해시태그 검색창 1 class
public class HashTagSearchOne extends JFrame {
	// 돼지 이미지
	JLabel lblImg;
	...
	private void init() {
		...
		tbtnTag1.add(getTbtn1("#월급"));
		tbtnTag1.add(getTbtn1("#부수입"));
		tbtnTag1.add(getTbtn1("#용돈"));
		tbtnTag1.add(getTbtn1("#상여"));
		tbtnTag1.add(getTbtn1("#금융소득"));
